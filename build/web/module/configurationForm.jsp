...
<openmrs:require privilege="Manage MOH-TRAC Portal Configurations" otherwise="/login.htm" redirect="/module/mohtracportal/configuration.form" />
...
<form action="configuration.form?save=true" method="post" style="width:90%; margin:6px auto;">
	<h2><spring:message code="mohtracportal.config.title"/></h2>
	<br/>
	...
	<c:if test="${mohtracConfigured.propertyValue=='false' || mohtracConfigured.propertyValue=='FALSE' || mohtracConfigured.propertyValue=='False'}">
		<div style="border: 1px solid red; padding: 3px; -moz-border-radius: 3px; font-size: 0.8em;">
			<spring:message code="mohtracportal.config.notice"/>
		</div>
	</c:if>
	
	<c:if test="${mohtracConfigured.propertyValue=='true' || mohtracConfigured.propertyValue=='TRUE' || mohtracConfigured.propertyValue=='True'}">
		<div class="box"><spring:message code="mohtracportal.config.configured"/></div>
	</c:if>
	<br/>
	
	<b class="boxHeader"><spring:message code="mohtracportal.config.general"/></b>
	<div class="box">
		<table class="configTable">
			<tr class="even">
				<td class="configDescription"><spring:message code="mohtracportal.config.recordperpage"/></td>
			...
			<tr>
				<td class="configDescription"><spring:message code="mohtracportal.config.location.default"/></td>
			...
			<tr class="even">
				<td class="configDescription"><spring:message code="mohtracportal.config.cd4count.critical"/></td>
	...
	<b class="boxHeader"><spring:message code="mohtracportal.config.identifiertype"/></b>
	<div class="box">		
		<table class="configTable">
	...
	<b class="boxHeader"><spring:message code="mohtracportal.config.program"/></b>
	<div class="box">
		<table class="configTable">
			<tr class="even">
				<td class="configDescription"><spring:message code="mohtracportal.config.program.hiv"/></td>
			...
			<tr>
				<td class="configDescription"><spring:message code="mohtracportal.config.program.pmtct"/></td>
	...
	<b class="boxHeader"><spring:message code="mohtracportal.config.attributes"/></b>
	<div class="box">
		<table class="configTable">
	...
	<span title="${mohtracConfigured.description}"><input <c:if test="${mohtracConfigured.propertyValue=='true' || mohtracConfigured.propertyValue=='TRUE'}">checked='checked'</c:if> type="checkbox" name="config_chkbx" id="config_chkbx_id" value="1"/><label for="config_chkbx_id"><spring:message code="mohtracportal.config.configured"/></label></span>
	
	<br/><br/>
	<input type="button" value="<spring:message code='mohtracportal.config.save'/>" id="btSave"/>
	<br/><br/>
...
$(document).ready( function() {
	$("#btSave").click(function(){
		if(confirm("<spring:message code='mohtracportal.general.message.confirm.save'/>"))
			this.form.submit();
		});
});
