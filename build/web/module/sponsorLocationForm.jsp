...
<openmrs:require privilege="Manage Locations/Sponsors" otherwise="/login.htm" redirect="/module/mohtracportal/locationsponsor.list?page=1" />
...
<form:form commandName="spLoc" method="post">
	...
	<table>
		<tr>
			<td>Location</td>
			<td><img border="0" src="<openmrs:contextPath/>/images/info.gif" title="<spring:message code="mohtracportal.help"/>"/></td>
