...
<openmrs:require privilege="View lab results" otherwise="/login.htm" redirect="/module/mohtracportal/samplecodemanagement.list?status=all&page=1" />

<h2><spring:message code="mohtracportal.test.list.title"/></h2>
<br/>
...
<div style="margin:5px; font-size: 0.9em;">
	<div id="list_container" style="width: 99%">
		<div id="list_title">
			<div class="list_title_msg"><spring:message code="mohtracportal.test.listing"/></div>
		...
		<table id="list_data">
			<tr>
				<th width="8%" class="columnHeader"><spring:message code="mohtracportal.test.date"/></th>
				<th width="3%" class="columnHeader numberCol">#.</th>
				<th width="10%" class="columnHeader"><spring:message code="mohtracportal.test.code"/></th>
				...
				<openmrs:hasPrivilege privilege="View Patient Names">
					<th width="20%" class="columnHeader"><spring:message code="mohtracportal.person.names"/></th>
				</openmrs:hasPrivilege>
				<th width="20%" class="columnHeader"><spring:message code="mohtracportal.test.name"/></th>
				<th width="15%" class="columnHeader"><spring:message code="mohtracportal.test.result"/></th>
				<th width="14%" class="columnHeader"><spring:message code="mohtracportal.test.comment"/></th>
			</tr>
			<c:if test="${empty sampletests}"><tr><td colspan="8" width="100%" style="text-align: center;"><spring:message code="mohtracportal.tablelist.empty"/></td></tr></c:if>
					...
					<tr>
						<c:if test="${prevPage!=-1}">
							<td width="100px" class="" style="padding:1px 2px 1px 2px; vertical-align: text-top;">
								<a href="samplecodemanagement.list?status=${param.status}&page=1"><div class="list_pageNumber" style="text-align: center;">|&lt; <spring:message code="mohtracportal.first"/></div></a>
							</td>
						...
						<c:if test="${nextPage!=-1}">
							...
							<td width="100px" class="" style="padding:1px 2px 1px 2px; vertical-align: text-top;">
								<a href="samplecodemanagement.list?status=${param.status}&page=${lastPage}"><div class="list_pageNumber" style="text-align: center;"><spring:message code="mohtracportal.last"/> &gt;|</div></a>
							</td>
						</c:if>
					</tr>
				</table>		
