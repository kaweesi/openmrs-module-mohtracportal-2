...
<openmrs:htmlInclude file="/moduleResources/mohtracportal/scripts/jquery.treeview.js" />
<openmrs:htmlInclude file="/moduleResources/mohtracportal/scripts/jquery.cookie.js" />
<openmrs:htmlInclude file="/moduleResources/mohtracportal/jquery.treeview.css" />
<openmrs:htmlInclude file="/moduleResources/mohtracportal/tracportal.css" />

<openmrs:require privilege="View MOH-TRAC Portal" otherwise="/login.htm" redirect="/module/mohtracportal/tracPortal.htm" />

<div style="font-size: 0.9em;">
	
	<div id="tracAdminListContent">
		
		<h1><spring:message code="mohtracportal.activities" /></h1>
		<br />
		
		<div id="patientTabs">
			<ul>
				<openmrs:hasPrivilege privilege="View TRAC Portal modules functionalities">
					<li><a hidefocus="hidefocus" onclick="return changeTab(this);" href="#" id="moduleTab" class="current "><spring:message code="mohtracportal.modules"/></a></li>
					<c:set var="canViewModules" value="1"/>
				</openmrs:hasPrivilege>
				<openmrs:hasPrivilege privilege="View TRAC Portal Administration Page">
					<li><a hidefocus="hidefocus" onclick="return changeTab(this);" href="#" id="administrationTab"><spring:message code="mohtracportal.administration"/></a></li>
				</openmrs:hasPrivilege>
				<li><a hidefocus="hidefocus" onclick="return changeTab(this);" href="#" <c:if test="${canViewModules eq null}">class="current "</c:if> id="generalTab"><spring:message code="mohtracportal.general"/></a></li>					
			</ul>
		</div>
		...
		<openmrs:hasPrivilege privilege="View TRAC Portal modules functionalities">
			...
			<div id="general" style="<c:if test="${canViewModules ne null}">display:none;</c:if> padding-left: 10px;">
				...
				<div class="adminMenuList">			
					<h4><spring:message code="mohtracportal.users.performance"/></h4>
					<ul id="menu">
						<li><a href="performance.htm"><spring:message code="mohtracportal.user.performance"/></a></li>
					</ul>
					
					<openmrs:hasPrivilege privilege="View TRAC Portal patients listing and export">
						<br/>
						<h4><spring:message code="mohtracportal.patient.listing"/></h4>
						<ul id="menu">
							<li><a href="patientList.htm?page=1"><spring:message code="mohtracportal.patientlist.title"/></a></li>
						</ul>
					</openmrs:hasPrivilege>
				</div>
			</div>
			...
			<div id="administration" style="display: none; padding-left: 10px;">
				<div class="adminMenuList">
					<openmrs:hasPrivilege privilege="Manage MOH-TRAC Portal Configurations">
						<h4><spring:message code="mohtracportal.configurations"/></h4>
						<ul id="menu">
							<li><a href="configuration.form"><spring:message code="mohtracportal.portal.configuration"/></a></li>
						</ul>
					</openmrs:hasPrivilege>
					
						<openmrs:hasPrivilege privilege="Manage Sponsors,Manage Locations/Sponsors">
							<br/>
							<h4><spring:message code="mohtracportal.locationsponsors"/></h4>
						</openmrs:hasPrivilege>
						<ul id="menu">
							<openmrs:hasPrivilege privilege="Manage Sponsors">
								<li><a href="sponsors.list?page=1"><spring:message code="mohtracportal.sponsors.manage"/></a></li>
							</openmrs:hasPrivilege>
							<openmrs:hasPrivilege privilege="Manage Locations/Sponsors">
								<li><a href="locationsponsor.list?page=1"><spring:message code="mohtracportal.locationsponsors.manage"/></a></li>
							</openmrs:hasPrivilege>
						</ul>
					
					<openmrs:hasPrivilege privilege="View lab results">		
						<br/>
						<h4><spring:message code="mohtracportal.test.samplecode"/></h4>
						<ul id="menu">
							<li><a href="samplecodemanagement.list?status=all&page=1"><spring:message code="mohtracportal.test.sample.manage"/></a></li>
						</ul>
					</openmrs:hasPrivilege>
							
					<br/>
					<h4><spring:message code="mohtracportal.regimen.title"/></h4>
					<ul id="menu">
