...
<ul id="menu">
	...
	<li class="first">
		<a href="tracportal.htm"><spring:message code="mohtracportal.activities" /></a>
	</li>
	...
	<openmrs:hasPrivilege privilege="Manage Sponsors">
		<li
			...
			<a href="sponsors.list?page=1"> <spring:message code="mohtracportal.sponsors.manage"/> </a>
		</li>
	</openmrs:hasPrivilege>
	...
	<openmrs:hasPrivilege privilege="Manage Locations/Sponsors">
		<li
			...
			<a href="locationsponsor.list?page=1"> <spring:message code="mohtracportal.locationsponsors.manage"/> </a>
		</li>
	</openmrs:hasPrivilege>
	...
	<openmrs:hasPrivilege privilege="View lab results">
		<li
			...
			<a href="samplecodemanagement.list?status=all&page=1"> <spring:message code="mohtracportal.test.sample.manage"/> </a>
		</li>
	</openmrs:hasPrivilege>
	...
	<openmrs:hasPrivilege privilege="View TRAC Portal patients listing and export">
		<li
			...
			<a href="patientList.htm?page=1"> <spring:message code="mohtracportal.patientlist.title"/> </a>
		</li>
	</openmrs:hasPrivilege>
	
	<li
		<c:if test='<%= request.getRequestURI().contains("userPerformance") %>'>class="active"</c:if>>
		<a href="performance.htm"> <spring:message code="mohtracportal.user.performance"/> </a>
	</li>
